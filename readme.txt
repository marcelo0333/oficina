O trabalho oficina se baseia no funcionamento basico para a criação de ordens de serviços.

Este sistema foi feito utilizando Java Spring MVC, Banco de Dados relacional(Postgresql), e foi utilizado fundamentos de jsp para algumas funções.
